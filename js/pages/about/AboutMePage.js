...
export default class AboutMePage extends Component {
  constructor(props) {
    ...
    this.aboutCommon = new AboutCommon({ ...this.params, navigation: this.params.navigation }, (dic) => this.updateState(dic), FLAG_ABOUT.flag_about_me, config)
    this.state = {
      projectModels: [],
      author: config.author,
      showReposiroty: false,
      showBlog: false,
      showQQ: false,
      showContact: false
    }
